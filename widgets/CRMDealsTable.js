...
import { formatLocaleDateString, formatLocaleString } from '../helpers';

export default function CRMDealsTable({ deals, leadScoreOptions, pagesOptions, titleOptions, ...props }) {
