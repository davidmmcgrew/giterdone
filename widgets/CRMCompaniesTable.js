...
export default function CRMContactsTable({ companies, leadScoreOptions, pagesOptions, titleOptions, ...props }) {
    ...
    () => [
      ...
      },
      {
        ...
        Cell: (props) => (
          <>
            <Avatar size="xs" className="me-2">
              <Avatar.Image src={props.cell.row.original.avatarSrc} alt={props.value} className="rounded-circle" />
            </Avatar>
